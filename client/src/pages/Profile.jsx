  ...
  return (
    <div className="flex flex-col w-full ">
      <div className="flex flex-col w-full justify-center items-center px-5 py-10">
        <h3 className="text-3xl self-start mb-4 text-gray-800 update-profile">
          Update Profile
        </h3>
        <form
          className="flex flex-col py-4 w-[300px] sm:w-[350px] md:w-[480px] lg:w-[650px] border border-[#3333] shadow-2xl/60 shadow-[#333] rounded-2xl text-sm text-slate-800"
        ...
        >
          <div className="px-4 h-full">
            ...
            <div className="flex flex-col gap-3">
              <label htmlFor="fileInput" className="font-semibold text-lg">
                Upload Image
              </label>
              {/* Hidden file input */}
              <input
